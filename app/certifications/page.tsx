...
export default function CertificationsPage() {
  return <div className="site-shell"><header className="site-header"><Brand /><Link className="nav-link" href="/">Back to home <CatalogIcon /></Link><AccountLink /></header><main className="catalog-page section-wrap"><CertificationCatalog /></main></div>;
}
